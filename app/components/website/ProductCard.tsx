...
export default function ProductCard({
  ...
  return (
    ...
    >
      ...
      <button className="w-full rounded-md cursor-pointer text-black border-amber-200/40 bg-amber-200 border border-accent py-2 text-sm text-accent hover:bg-accent hover:text-bg transition">
        Get Quote
      </button>
    </motion.div>
  );
